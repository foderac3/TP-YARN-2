...
public class SpeciesDriver extends Configured implements Tool {
    public int run(String[] args) throws Exception {
        Configuration conf = getConf();
        Job job = Job.getInstance(conf, "species list");
        job.setJarByClass(SpeciesDriver.class);
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new SpeciesDriver(), args);
        System.exit(res);
    }
}
